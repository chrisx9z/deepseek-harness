...
flowchart TD
  ...
  subgraph group_session_query["packages/session-query"]
    pkg_session_chat_share["session-chat-share"]
  ...
  pkg_session_chat_share --> pkg_api_remotes
  pkg_session_chat_share --> pkg_client_connection
  pkg_session_chat_share --> pkg_client_locale
  pkg_session_chat_share --> pkg_client_runtime
  pkg_session_chat_share --> pkg_client_ui_commands
  pkg_session_chat_share --> pkg_client_ui_conversation
  pkg_session_chat_share --> pkg_client_ui_workspace
  pkg_session_chat_share --> pkg_commands
  pkg_session_chat_share --> pkg_invariants
...
| [`session-chat-share`](../packages/session-query/session-chat-share) | `session-query` | [`api-remotes`](../packages/api/remotes), [`client-connection`](../packages/client/connection), [`client-locale`](../packages/client/locale), [`client-runtime`](../packages/client/runtime), [`client-ui-commands`](../packages/client/ui-commands), [`client-ui-conversation`](../packages/client/ui-conversation), [`client-ui-workspace`](../packages/client/ui-workspace), [`commands`](../packages/interaction/commands), [`invariants`](../packages/runtime-diagnostics/invariants) |
