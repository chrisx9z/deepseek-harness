...
describe('renderShareHtml', () => {
  ...
  it('embeds resolved images as data URIs and keeps markers for missing ones', () => {
    const withImage: ShareMessage[] = [
      { seq: 1, role: 'user', text: 'look', time: 1, images: [{ attachmentId: 'img-1', mediaType: 'image/png', name: 'shot.png' }] },
    ]
    const missing: ShareMessage[] = [
      { seq: 2, role: 'user', text: '', time: 2, images: [{ attachmentId: 'img-2', mediaType: 'image/png', name: 'gone.png' }] },
    ]
